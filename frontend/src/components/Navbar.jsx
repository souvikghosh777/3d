...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/gallery', label: 'Model Gallery', icon: '🖼️' },
    { path: '/templates', label: 'Prompt Templates', icon: '📝' },
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 backdrop-blur-md border-b border-gray-700 shadow-xl">
